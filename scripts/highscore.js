Breakout.screens['high-score'] = (function(game) {
	'use strict';
	...
	function addScore(scoreIn) {
		...
		localStorage['VWLBreakout.HighScores'] = JSON.stringify(highScores);
	}
	...
	function initalize() {
		...
		var prevScores = localStorage.getItem('VWLBreakout.HighScores');
